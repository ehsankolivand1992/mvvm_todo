 ...
 * [FragToDo.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [FragToDo.newInstance] factory method to
 * create an instance of this fragment.
 */
class FragToDo : Fragment(),AdapterEventistinner,DialogListinner {
    ...
    private fun InitRcv() {
        val adapter = TodoAdapter(this, FragDone(),1)
        rcv_tasks.adapter = adapter
        rcv_tasks.layoutManager = LinearLayoutManager(context)

        mainTaskViewModel.allTask.observe(this, Observer { task ->
            task?.let {
                adapter.setTask(it)
            }
        })
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_frag_to_do, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment FragToDo.
         */
    ...
    override fun edit(task: TaskModel) {
      ...
      val mydialog = EditTaskDialog(task,activity as Activity,this,FragDone(),1)
